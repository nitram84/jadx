...
public class AndroidLinterPass implements JadxDecompilePass {
	...
	public void init(final RootNode root) {
		...
		final LinterRuleLoader ruleLoader = new LinterRuleLoader(root);
		ruleLoader.loadAndroidConstants("linter/android.txt");
		ruleLoader.loadAndroidConstants("linter/additional-constants.txt");
		ruleLoader.loadAndroidLinterRules("linter/android.xml", "Android SDK");
		ruleLoader.loadLibraryRules("maven-google");
